...
const contactID = 1; // Ваш контактный ID

const formsArray: Array<FormMenu> = [
  {
    id: 1,
    title: "Прилегающая территория и внешние фасады зданий",
    description: 'oiqwenoiqwefin qwefinoqwefn wqeifoqnwefiqowefnew',
    component: <Form 
                  title={'Прилегающая территория и внешние фасады зданий'} 
                  IQ={[
  ...
  {
    id: 2,
    title: "Территория квартала",
    description: 'qweoinfqwief qweoifnqweofin qweoifnqweoinf',
    component: <Form 
                  title={'Территория квартала'} 
                  IQ={[
  ...
  },
  {
    id: 3,
    title: "ЦТИ",
    description: 'oqewinfioqwenf qwefoinqweifon qwefvre ',
    component: <Form 
                  title={'ЦТИ'} 
                  IQ={[
                    ...
                    { id: 8, title: 'Туалеты -1 этаж', options: ['чисто (пол, стены, двери, зеркала, сантехника, раковины, унитазы, писсуары, ершики, оборудование)', 'нет новых повреждений отделки', 'краны и слив работает', 'двери исправны, нет скрипа', 'туалетная бумага в наличии', 'салфетки для рук в наличии', 'мыло в наличии', 'сушилка для рук работает', 'освежители работают, нет неприятного запаха', 'освещение исправно, работает'] },
                    { id: 9, title: 'Доступный туалет -1 этаж', options: ['Чисто', 'нет новых повреждений отделки', 'кран и слив работает', 'дверь исправна, нет скрипа', 'туалетная бумага в наличии', 'салфетки для рук в наличии', 'мыло в наличии', 'сушилка для рук работает', 'поручни работают', 'освежитель работают, нет неприятного запаха', 'освещение исправно, работает'] },
                    { id: 10, title: 'Хранение', options: ['Чисто', 'нет новых повреждений отделки', 'нет отпечатков и следов на стеклянной стене', 'освещение исправно, работает'] },
                    { id: 11, title: 'Выставочный зал 1 этаж', options: ['Чисто', 'турникеты работают, нет скрипа', 'нет новых повреждений отделки', 'освещение исправно, работает', 'нет постороннего шума'] },
                    { id: 12, title: 'Лестница на 2 этаж', options: ['Чисто', 'нет новых повреждений отделки', 'арт-объекты без повреждений', 'экраны работают', 'освещение исправно, работает', 'тактильная плитка цела'] },
                    { id: 13, title: 'Лестница на 3 этаж', options: ['Чисто', 'нет новых повреждений отделки', 'арт-объекты без повреждений', 'экраны работают', 'освещение исправно, работает', 'тактильная плитка цела'] },
                    { id: 14, title: 'Холл 2 этаж + лифтовый холл', options: ['Чисто', 'Чисто', 'нет новых повреждений отделки', 'мебель на месте, без повреждений', 'освещение исправно, работает'] },
                    { id: 15, title: 'Коворкинг', options: ['Чисто', 'нет новых повреждений отделки', 'мебель на месте, без повреждений', 'освещение исправно, работает', 'козырёк за окном чистый'] },
                    { id: 16, title: 'Выставочный зал 2 этаж', options: ['Чисто', 'освещение исправно, работает', 'турникеты работают, нет скрипа', 'нет новых повреждений отделки', 'нет постороннего шума'] },
                    { id: 17, title: 'Помещение магазина', options: ['Чисто', 'нет новых повреждений отделки', 'в пространстве порядок', 'освещение исправно, работает'] },
                    { id: 18, title: 'Кафе', options: ['Чисто', 'нет новых повреждений отделки', 'в пространстве порядок', 'освещение исправно, работает'] }
                  ]}
                  contactID={contactID}
                />
  }
