...
const formsArray: Array<FormMenu> = [
  { id: 1, title: "Прилегающая территория и внешние фасады зданий", description: '', component: <Form title={'Прилегающая территория и внешние фасады зданий'} IQ={[
  ...
  { id: 2, title: "Территория квартала", description: '', component: <Form title={'Территория квартала'} IQ={[
  ...
  { id: 3, title: "ЦТИ", description: '', component: <Form title={'ЦТИ'} IQ={[
